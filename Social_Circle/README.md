# SeisCLIP for Event Classification and Clustering

This part of code is used for event classification and cluster, and we used the pretrained model. For use the code, you should put the pretrained weights under the "pretrained_models file".
